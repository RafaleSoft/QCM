...
const int kNumOutputsPerRegister = 8;
// Maximum number of registers that we will use.
const int kMaxOutputRegisters = 8;
// Number of inputs in the inputs register.
const int kNumInputsPerRegister = 32;
// Number of inputs in each weight group.
const int kNumInputsPerGroup = 4;
// Number of groups of inputs to be broadcast.
const int kNumInputGroups = kNumInputsPerRegister / kNumInputsPerGroup;
