...
bool CPNGImaging::storeImageFile(const std::string& fname, CImage* const I) const
{
	...
	if ((CImage::CGL_COLOR24 == I->getPixelType()) ||
		(CImage::CGL_COLOR_FLOAT16 == I->getPixelType()) ||
		(CImage::CGL_COLOR_FLOAT32 == I->getPixelType()))
		wpng_info.pnmtype = 6;
	else if ((CImage::CGL_COLOR24_ALPHA == I->getPixelType()) ||
			 (CImage::CGL_COLOR_FLOAT16_ALPHA == I->getPixelType()) ||
			 (CImage::CGL_COLOR_FLOAT32_ALPHA == I->getPixelType()))
		wpng_info.pnmtype = 8;
	else
		wpng_info.pnmtype = 8;
